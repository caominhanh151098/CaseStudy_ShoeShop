    ...
    public List<User> findAll(Pageable pageable) {
        ...
        try (Connection connection = getConnection();
            ...
            while (rs.next()) {
                ...
                UserInfo userInfo = new UserInfo(user_id, name, dob, email, phone, address);
...
//        User newUser = findByUserName(user.getUsername());
        ...
        UserInfo userInfo = new UserInfo(user.getId(), user.getUser_info().getName(), user.getUser_info().getDob(), user.getUser_info().getEmail(), user.getUser_info().getPhone(), user.getUser_info().getAddress());
