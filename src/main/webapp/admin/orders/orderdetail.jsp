            ...
            <tr>
                ...
                <td>
                    <c:forEach items="${products}" var="product">
                        <c:if test="${product.id == orderdetail.productID}"><img src="${product.image}" width="50px"></c:if>
                    </c:forEach>
                </td>
                <td>${orderdetail.productName}</td>
                <td><fmt:formatNumber type="number" value="${orderdetail.price}"/>đ</td>
                <td>${orderdetail.quantity}</td>
                <td align="right"><fmt:formatNumber type="number" value="${orderdetail.price * orderdetail.quantity}"/>đ</td>
            </tr>
        </c:forEach>
        </tbody>
        <tfoot>
