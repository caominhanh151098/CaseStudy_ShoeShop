...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="../assets/img/favicon/logo2.jpg"/>
<%--    <input type="image" src="../assets/img/favicon/logo.jpg" alt="Submit" >--%>
...
<%--                        <img src="../assets/img/favicon/logo1.png" alt="photo">--%>
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2" style="color: #f8d557">Shoe Shop</span>
                </a>
                ...
                <%--            <i class="menu-icon tf-icons bx bx-layout"></i>--%>
                <%--            <div data-i18n="Layouts">Revenue</div>--%>
                <%--          </a>--%>
                <%--        </li>--%>
                <%--      </ul>--%>
                <%--    </aside>--%>
                ...
                <%--                    <i class="bx bx-chevron-left bx-sm align-middle"></i>--%>
                <%--                </a>--%>
                <%-->>>>>>> 9d33ea4227b2e97570170d2096154cd4bbdc2657--%>
            </div>
