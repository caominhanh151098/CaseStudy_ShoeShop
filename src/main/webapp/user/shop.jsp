            ...
            <div class="bg-light p-4 mb-30">
                <form>
                    ...
                    <c:forEach var="eprice" items="${prices}">
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input prices" id="price-1${eprice.value}" value="${eprice.value}" onclick="filterByPrice()"
                        ...
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <div class="product-action">
                                    <a class="btn btn-outline-dark btn-square" href="/shop?action=show&id=${product.id}"><i
...
<%--<script src="user/js/shop.jsp"></script>--%>
